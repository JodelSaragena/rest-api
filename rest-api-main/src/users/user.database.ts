...
export const findByEmail = async (user_email: string): Promise<null | UnitUser> => {
 ...
 export const comparePassword = async (email : string, supplied_password : string) : Promise<null | User> => {
    ...
    export const update = async (id : string, updateValues : User) : Promise<null | User> => {
